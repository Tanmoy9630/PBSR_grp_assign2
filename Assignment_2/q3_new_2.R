...
l1=NegLogLikeMix(theta_hat1,waiting)*-1
l1
log(d_1st)
#plot(d_1st)
...
l2=LogLikeMix2(theta_hat2,waiting)*-1
l2
#############################################################
...
### since aic valie of the last model(log-normal and log-normal) is minimum , hence its the best model .
